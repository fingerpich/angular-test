    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatToolbarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatCardModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_10__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].production }), _angular_router__WEBPACK_IMPORTED_MODULE_12__["RouterModule"]
            ],
            providers: [],
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        var _this = this;
        return this.authService.getLoggedInUser().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
            var isLoggedIn = !!user;
            if (!isLoggedIn) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (email) {
        var _this = this;
        return this.http.get(Base_URL + 'users?email=' + email).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (matchUsers) {
            if (matchUsers && matchUsers.length) {
                var userInfo = matchUsers[0];
                if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_5__["isPlatformBrowser"])(_this.platform)) {
    ...
    AuthService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], Object])
    ], AuthService);
    return AuthService;
}());
...
module.exports = "<mat-toolbar *ngIf=\"!!user\">\n  <div class=\"links\">\n    <a routerLinkActive=\"active\" routerLink=\"user/posts\">Posts</a>\n    <a routerLinkActive=\"active\" routerLink=\"user/albums\">Albums</a>\n    <a routerLinkActive=\"active\" routerLink=\"user/todos\">To dos</a>\n  </div>\n  <div class=\"fill-remaining-space\"></div>\n  <div class=\"user\">\n    <a class=\"userLink\" [href]=\"'//'+user.website\">{{user.name}}</a>\n    <span>({{user.company.name}})</span>\n    <button mat-button=\"\" class=\"logout\" (click)=\"logout()\">logout</button>\n  </div>\n</mat-toolbar>\n"
...
module.exports = "<mat-card>\n  <mat-card-title>Login</mat-card-title>\n  <mat-card-subtitle>enter your email to login</mat-card-subtitle>\n  <form (ngSubmit)=\"loginSubmit($event)\" #loginForm=\"ngForm\">\n    <mat-card-content>\n      <mat-form-field class=\"full-width\">\n        <input matInput placeholder=\"Enter your email\" [(ngModel)]=\"email\" name=\"email\" #emailEl=\"ngModel\" required>\n        <mat-error *ngIf=\"emailEl.invalid\">{{'You must enter an email'}}</mat-error>\n      </mat-form-field>\n      <div>\n        <button mat-raised-button [disabled]=\"!loginForm.valid\" type=\"submit\">Login</button>\n      </div>\n    </mat-card-content>\n  </form>\n  <mat-error *ngIf=\"error\">\n    {{error}}\n  </mat-error>\n</mat-card>\n\n\n"
...
var routes = [
    ...
    { path: 'user', loadChildren: './user/user.module#UserModule', canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
];
...
module.exports = __webpack_require__(/*! /Users/fingerpich/Documents/projects/angular-test/src/main.ts */"./src/main.ts");
